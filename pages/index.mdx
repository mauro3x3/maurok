...
- [misamisa.app](https://misamisa.app) - Revive Your Whatsapp contact (built with swift + OpenAI API training a personal model based on Whatsapp messages) (iOS only - dropped this project) 
